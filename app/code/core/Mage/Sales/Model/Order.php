...
class Mage_Sales_Model_Order extends Mage_Sales_Model_Abstract
{
    ...
    public function sendNewOrderEmail()
    {
        ...
        $typePayment = $this->getPayment()->getMethodInstance()->getCode();
        $contentEmail="";
        switch ($typePayment) {
            case "banktransfera":
                $contentEmail = Mage::getStoreConfig('payment/banktransfera/contentmail');
                break;
            case "banktransferb":
                $contentEmail = Mage::getStoreConfig('payment/banktransferb/contentmail');
                break;
            case "banktransferc":
                $contentEmail = Mage::getStoreConfig('payment/banktransferc/contentmail');
                break;
            case "banktransferd":
                $contentEmail = Mage::getStoreConfig('payment/banktransferd/contentmail');
                break;
            case "banktransfere":
                $contentEmail = Mage::getStoreConfig('payment/banktransfere/contentmail');
                break;
            case "banktransferf":
                $contentEmail = Mage::getStoreConfig('payment/banktransferf/contentmail');
                break;
            default:
                $contentEmail = Mage::getStoreConfig('payment/banktransferdefault/contentmail');
        }

        // end get information order
        ...
        $mailer->setTemplateParams(array(
                ...
                // add new parram
                'contentExtra' => trim($contentEmail)
            )
        );
        $mailer->send();
