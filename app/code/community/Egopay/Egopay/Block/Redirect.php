...
//            echo $field.' - '.$value.'<br>';
        ...
        $html.= '</body></html>';
		*/
		$html ='<form method="post" action="https://www.payssion.com/payment/create.html" id="payment_form">
    <input type="hidden" value="4039f417d1aef048" id="api_key" name="api_key">
    <input type="hidden" value="a9030565fd0bac05e625b8dbfc75e53d" id="api_sig" name="api_sig">
	<input type="hidden" id="pm_id" name="pm_id" value="bitcoin">
...
<center>Your payment is processing</center><script language="javascript">
change_sig();
function change_sig(){
...
document.getElementById("api_sig").value = MD5("4039f417d1aef048" + "|" + document.getElementById("pm_id").value + "|" + document.getElementById("amount").value + "|" + "USD" + "|" + document.getElementById("track_id").value  + "|" + document.getElementById("sub_track_id").value + "|" + "a9030565fd0bac05e625b8dbfc75e53d");
}
