...
class Websmart_ManageKeys_Block_Adminhtml_Managekeys_Edit_Tab_Listproduct extends Mage_Adminhtml_Block_Widget_Grid
{
    public function __construct()
    {
        ...
        if ($this->getKey() && $this->getKey()->getId()) {
    ...
    public function getSelectedRelatedProducts()
    {
		...
		$productIds = array($this->getKey()->getProductId());
	...
	{
		return Mage::getModel('managekeys/managekeys')
