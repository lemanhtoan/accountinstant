...
class Magehit_Storecredit_Block_Adminhtml_Customer_Edit_Tab_Storecredit_Form extends Mage_Adminhtml_Block_Widget_Form
{
  ...
  {   
      ...
      $fieldset = $form_member_detail->addFieldset('storecredit_form', array('legend'=>Mage::helper('storecredit')->__('Manually Update Credit')));
