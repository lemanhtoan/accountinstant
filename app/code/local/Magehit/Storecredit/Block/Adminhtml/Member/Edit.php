...
class Magehit_Storecredit_Block_Adminhtml_Member_Edit extends Mage_Adminhtml_Block_Widget_Form_Container
{
    public function __construct()
    {
        ...
        $this->_updateButton('save', 'label', Mage::helper('storecredit')->__('Save Member'));
    ...
    {   
    	...
    	if(isset($customer_id)){
    		...
    		return Mage::helper('storecredit')->__($this->htmlEscape($name));
    	}
