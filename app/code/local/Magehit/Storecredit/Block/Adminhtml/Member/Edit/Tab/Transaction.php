<?php
class Magehit_Storecredit_Block_Adminhtml_Member_Edit_Tab_Transaction extends Mage_Adminhtml_Block_Widget_Grid
{
    ...
    {
    	return $this->getUrl('storecredit/adminhtml_member/transaction', array('id'=>$this->getRequest()->getParam('id')));
