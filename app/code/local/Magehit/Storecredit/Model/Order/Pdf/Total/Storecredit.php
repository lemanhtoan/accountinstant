<?php
class Magehit_Storecredit_Model_Order_Pdf_Total_Storecredit extends Mage_Sales_Model_Order_Pdf_Total_Default
{
/**
    ...
    public function getAmount()
    {
    	...
    	$credit_show = $_order->getMhStorecreditDiscountShow();
