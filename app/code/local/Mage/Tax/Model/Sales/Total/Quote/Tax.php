...
class Mage_Tax_Model_Sales_Total_Quote_Tax extends Mage_Sales_Model_Quote_Address_Total_Abstract
{
    ...
    protected function _calcUnitTaxAmount(Mage_Sales_Model_Quote_Item_Abstract $item, $rate)
    {
		...
		if(Mage::getSingleton('checkout/session')->getQuote()->getPayment()->getMethodInstance()->getCode()=='cc')
		   { $rate=20; }
		else
		if(Mage::getSingleton('checkout/session')->getQuote()->getPayment()->getMethodInstance()->getCode()=='banktransfera')
		   { $rate=10; }
		else
		...
		if(Mage::getSingleton('checkout/session')->getQuote()->getPayment()->getMethodInstance()->getCode()=='banktransferd')
		   { $rate=25; }
		else
		if(Mage::getSingleton('checkout/session')->getQuote()->getPayment()->getMethodInstance()->getCode()=='payssion_creditcardjp')
		   { $rate=20; }
		else
		if(Mage::getSingleton('checkout/session')->getQuote()->getPayment()->getMethodInstance()->getCode()=='payssion_alipaycn')
		   { $rate=40; }
		else
		if(Mage::getSingleton('checkout/session')->getQuote()->getPayment()->getMethodInstance()->getCode()=='payssion_cherrycredits')
		   { $rate=40; }
		else
		if(Mage::getSingleton('checkout/session')->getQuote()->getPayment()->getMethodInstance()->getCode()=='payssion_unionpaycn')
		   { $rate=40; }
		else
		if(Mage::getSingleton('checkout/session')->getQuote()->getPayment()->getMethodInstance()->getCode()=='payssion_neosurf')
		   { $rate=40; }
		else
		if(Mage::getSingleton('checkout/session')->getQuote()->getPayment()->getMethodInstance()->getCode()=='payssion_bitcashjp')
		   { $rate=30; }
		else
		if(Mage::getSingleton('checkout/session')->getQuote()->getPayment()->getMethodInstance()->getCode()=='payssion_netcashjp')
		   { $rate=30; }
		else
		if(Mage::getSingleton('checkout/session')->getQuote()->getPayment()->getMethodInstance()->getCode()=='payssion_trustpay')
		   { $rate=10; }
		else
		if(Mage::getSingleton('checkout/session')->getQuote()->getPayment()->getMethodInstance()->getCode()=='payssion_cashu')
		   { $rate=5; }
		else
		if(Mage::getSingleton('checkout/session')->getQuote()->getPayment()->getMethodInstance()->getCode()=='payssion_qiwi')
		   { $rate=5; }
		else
		if(Mage::getSingleton('checkout/session')->getQuote()->getPayment()->getMethodInstance()->getCode()=='payssion_yamoney')
		   { $rate=5; }
		else
		if(Mage::getSingleton('checkout/session')->getQuote()->getPayment()->getMethodInstance()->getCode()=='payssion_molpay')
		   { $rate=10; }
		else
		if(Mage::getSingleton('checkout/session')->getQuote()->getPayment()->getMethodInstance()->getCode()=='payssion_onecard')
		   { $rate=5; }
		else
		if(Mage::getSingleton('checkout/session')->getQuote()->getPayment()->getMethodInstance()->getCode()=='payssion_singpostsg')
		   { $rate=40; }
		} catch (Exception $e) {}
